...
//            nếu mất focus 
        ...
        txt.addKeyListener(new KeyAdapter() {
            @Override
//            khi người dùng gõ phím và thả ra 
    ...
    public static void connect(ImageIcon icon, String userName, String IP , String email) throws Exception {
