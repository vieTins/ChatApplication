...
//           KEY_INTERPOLATION để thu nhỏ hình ảnh mựơt mà hơn 
...
//           vẽ hình ảnh 
    ...
    private Rectangle getAutoSize(Icon image) {
        int w = getWidth();
        int h = getHeight();
//        check xem thử w , h của hình ảnh có lớn hơn thành phần chứa không 
...
//        tính toán để in hình ảnh ra trung tâm phần chứa 
